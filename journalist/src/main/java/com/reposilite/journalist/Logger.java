...
public interface Logger extends Journalist {
    ...
    /**
     * Log the given message to {@link com.reposilite.journalist.Channel#FATAL} channel
     *
    ...
    /**
     * Log the given message to {@link com.reposilite.journalist.Channel#ERROR} channel
     *
     * @param message the message to log
     * @param arguments arguments to the message
     * @return the logger instance
    ...
    /**
     * Log the given message to {@link com.reposilite.journalist.Channel#WARN}
     *
     * @param message the message to log
     * @param arguments arguments to the message
     * @return the logger instance
    ...
    /**
     * Log the given message to {@link com.reposilite.journalist.Channel#INFO}
     *
     * @param message the message to log
     * @param arguments arguments to the message
     * @return the logger instance
    ...
    /**
     * Log the given message to {@link com.reposilite.journalist.Channel#DEBUG}
     *
     * @param message the message to log
     * @param arguments arguments to the message
     * @return the logger instance
    ...
    /**
     * Log the given message to {@link com.reposilite.journalist.Channel#TRACE}
     *
     * @param message the message to log
     * @param arguments arguments to the message
     * @return the logger instance
    ...
    /**
     * Log the given exception to the {@link com.reposilite.journalist.Channel#ERROR} channel
     *
